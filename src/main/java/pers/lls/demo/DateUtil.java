...
public class DateUtil {
	...
	public  final SimpleDateFormat sdf3=new SimpleDateFormat("yyyy/MM/dd-HH:mm:ss");
    ...
    public static Long getJsonDate(JSONObject jsonObject, String key){

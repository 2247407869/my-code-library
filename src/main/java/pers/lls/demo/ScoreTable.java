...
public class ScoreTable {
    private ScoreTable() {}
    public static int FIVE = 100;//成5
    public static int DOUBLE_ALIVE_FOUR = 99;//双活4(分析对手用)
    public static int ALIVE_FOUR_AND_DEAD_FOUR = 98;//活4死4(对手分析用)
    public static int ALIVE_FOUR_AND_ALIVE_THREE = 96;//活4活3(分析对手用)
    public static int ALIVE_FOUR_AND_DEAD_THREE = 95;//活4死3(分析对手用)
    public static int ALIVE_FOUR_AND_ALIVE_TWO = 94;//活4活2
    public static int ALIVE_FOUR = 93;//活4

...
public class App 
{
    ...
    {
        String input = "KAFKA_TEST";   //输入 topic
        String output = "KAFKA_TEST2";  //输出 topic

        Properties properties = new Properties();
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG,"logProcessor");
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,"10.1.11.53:9192");
        ...
        KStream<String, String> upperCasedStream = simpleFirstStream.mapValues(line -> line.split("你好")[1]);
        // 把转换结果输出到另一个topic
